 ...
 **/
const rotateByStyle = (percent: number, base_degrees: number, clockwise: boolean) => {
...
const CircularProgress = ({
  ...
  return (
    <View style={[styles.container, { width: radius * 2, height: radius * 2 }, style]}>
      ...
      {withText && (
        <Text style={[styles.display, { fontSize: textFontSize, fontWeight: textFontWeight }]}>{progress}/7</Text>
      )}
    </View>
  )
}
